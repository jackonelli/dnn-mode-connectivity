...
print(
    tabulate.tabulate([
        [
            "train loss", tr_loss[0], tr_loss[-1], tr_loss_min, tr_loss_max,
            tr_loss_avg, tr_loss_int
        ],
        [
            "train error (%)", tr_err[0], tr_err[-1], tr_err_min, tr_err_max,
            tr_err_avg, tr_err_int
        ],
        [
        ...
        [
            "test error (%)", te_err[0], te_err[-1], te_err_min, te_err_max,
            te_err_avg, te_err_int
        ],
