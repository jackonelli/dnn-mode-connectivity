...
def print_epoch(train_res, test_res, lr, epoch, start_epoch, epoch_duration):
    ...
    values = [
        ...
        test_res["accuracy"], epoch_duration
    ]
...
def save_model(epoch, save_freq, save_dir, model, optimizer):
...
def parse_args():
    ...
    parser.add_argument("--init_start",
                        type=str,
                        default=None,
                        metavar="CKPT",
                        help="checkpoint to init start point (default: None)")
    parser.add_argument("--fix_start",
                        dest="fix_start",
                        action="store_true",
                        help="fix start point (default: off)")
    parser.add_argument("--init_end",
                        type=str,
                        default=None,
                        metavar="CKPT",
                        help="checkpoint to init end point (default: None)")
    parser.add_argument("--fix_end",
                        dest="fix_end",
                        action="store_true",
    ...
    parser.add_argument(
        ...
        action="store_false",
        help=
        "turns off linear initialization of intermediate points (default: on)")
    parser.add_argument(
        "--resume",
        type=str,
        default=None,
